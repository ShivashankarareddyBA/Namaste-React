...
//           </div>
//           <div className="w-3/12 p-4 mx-auto" >
//             <div className="absolute"> 
//             <button className=" p-2 mx-4 my-10 rounded-lg bg-slate-200 text-black shadow-lg"
//             onClick={()=> handleAddItem(item)}> Add +</button>
//             </div>
//             <img src={IMG + item.card.info.imageId}  className="w-32 h-32 object-cover"/>
//             </div>
//         </div>
//       ))}
//     </div>
        ...
        >
          ...
          <div className="w-3/12 p-4 mx-auto relative">
            <div className="absolute top-0 right-0">
              <button
                className="p-2 mx-4 my-2 rounded-lg bg-slate-200 text-black shadow-lg"
